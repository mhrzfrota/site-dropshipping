        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-stretch">
          <div className="card-surface p-6 sm:p-8">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl bg-stone-50 p-4">
                ...
                <p className="mt-2 text-sm font-semibold text-stone-700">Rua Costa e Silva, 116 C</p>
                <p className="text-sm text-stone-600">Loteamento Primavera, Paudalho - PE, 55825-000</p>
              </div>
              <div className="rounded-2xl bg-stone-50 p-4">
                ...
                <p className="text-sm font-semibold text-stone-700">Sex: 07:30 às 17:00</p>
                <p className="text-sm text-stone-600">Sáb e Dom: Fechado</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-brand-aqua/30 bg-white/80 p-6 shadow-lg">
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-2 rounded-xl bg-green-500 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-green-600"
            >
